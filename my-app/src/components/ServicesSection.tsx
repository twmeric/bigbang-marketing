    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-item">
          <p className="text-yellow-500 font-semibold text-lg mb-3">我們的專業服務</p>
          <h2 className="text-4xl md:text-5xl font-bold mb-4">服務項目</h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            提供全方位的數碼營銷解決方案，協助您的品牌在競爭激烈的市場中脫穎而出
          </p>
